...
class Scraper:
    def __init__(
        ...
        scraping_start_year_month: str = "2022-01",
        scraping_end_year_month: str = "2022-01",
        ...
        self.start_date = scraping_start_year_month
        self.end_date = scraping_end_year_month
    ...
    def generate_dataset_names(self) -> list:
        ...
        return [month.strftime("%Y-%m.parquet") for month in month_list]
    ...
    def download_required_datasets(self):
        ...
        for dataset in self._datasets_to_download:
            ...
            try:
                if dataset_name not in files_in_folder:
                    ...
                    with open(f"../raw_data/{dataset_name}", "wb") as handler:
